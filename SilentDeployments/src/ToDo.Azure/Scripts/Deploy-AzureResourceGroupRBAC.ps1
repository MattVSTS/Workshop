...
Param(
  ...
  [string] $ResourceGroupName = 'MultiChannelToDo',  
...
Switch-AzureMode AzureResourceManager
$secpasswd = ConvertTo-SecureString "7HIPmV2fPs1TngGzfLBEew8jnmXwnc37aYLMiOb62ic=" -AsPlainText -Force
$mycreds = New-Object System.Management.Automation.PSCredential ("b4edc0fa-e4af-4c0f-8200-443bb1e694b5", $secpasswd)

Add-AzureAccount -ServicePrincipal -Tenant f42d0daa-3176-4ea0-9e71-90c26b1a87de -Credential $mycreds

New-AzureResourceGroup -Name $ResourceGroupName -Location $ResourceGroupLocation -TemplateFile $TemplateFile -TemplateParameterFile $TemplateParametersFile @OptionalParameters -Force -Verbose