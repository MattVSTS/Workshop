...
namespace MultiChannelToDo.Controllers
{
    public class ToDoItemsController : ApiController
    {
        ...
        public async Task<IHttpActionResult> PostToDoItem(TodoItem toDoItem)
        {
            ...
            //toDoItem.URef = Counter();
            toDoItem.Id = Guid.NewGuid().ToString().ToUpper();
        ...
        //int Counter()
        //{
        //    var top = db.ToDoItems.OrderByDescending(c => c.URef).First();
        //    if (top.URef.HasValue)
        //    {
        //        int x = top.URef.Value;
        //        return x + 1;
        //    }
        //    else
        //    {
        //        int y = db.ToDoItems.Count();
        //        return y + 1;
        //    }
        //}
    }
